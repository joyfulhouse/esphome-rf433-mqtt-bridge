...
// Floor for every bucket the transmitter actually keys: the opt-in OB38S003
// compensation (b0_with_bucket_offset in components/rf_bridge/
// rf_bridge_protocol.h, applied once in RFBridgeComponent::send_raw) emits
// max(duration - offset, B0_MIN_BUCKET_US) per bucket for a compile-time
// offset of 0..255 us this header never sees. The airtime estimate sums
